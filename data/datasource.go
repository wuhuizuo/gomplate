...
func (d *Data) readSource(ctx context.Context, source *Source, args ...string) (*fileContent, error) {
	...
	fc, err := readFileContent(ctx, u, source.Header)
	if err != nil {
		return nil, err
	}
	d.cache[cacheKey] = fc
...
func readFileContent(ctx context.Context, u *url.URL, hdr http.Header) (*fileContent, error) {
	...
	// TODO: I don't want this here - auth methods should all be injected
	// earlier
